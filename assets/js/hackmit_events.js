...
var HMIT_EVTS = [
    ...
    [10.5, 11.5, "Opening Ceremony", "Kresge", 0],
    [11.5, 12, "Team Formation", "Johnson Lobby", 0],
    [11.5, 11.5, "Hacking starts!", "Johnson Lobby", 0],
    ...
    [20.75, 21.75, "Q&A with Maria Latushkin, Charlie Cheever, and Austin McChord", "Johnson Media Room", 1],
    ...
    [22.75, 23.25, "Fireside Chat 3: John Whaley", "Johnson Media Room", 1],
    ...
    [35.5, 35.5, "Hacking Ends!", "Johnson Ice Rink", 0],
    [35.5, 37, "Expo Judging", "Johnson Ice Rink", 0],
    [35.5, 37, "Expo Judging (Hololens)", "Johnson Media Room", 0],
